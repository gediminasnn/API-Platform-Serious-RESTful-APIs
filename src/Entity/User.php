...
class User implements UserInterface
{
     ...
     * @Groups({"user:read","user:write","cheese_listing:item:write"})
     * @Assert\NotBlank()
     * @Assert\Email()
     */
    private $email;
     ...
     * @Groups({"user:write","cheese_listing:item:write"})
     * @Assert\NotBlank()
     */
    private $password;
     ...
     * @Groups({"user:read","user:write","cheese_listing:item:get","readas","cheese_listing:item:write"})
     * @Assert\NotBlank
     */
    private $username;
